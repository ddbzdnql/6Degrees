...
actorconnections: ActorGraph.o MoviesByYear.o

extension: TGraph.o

TGraph.o: TNode.h TGraph.h

MoviesByYear.o: Node.h Edge.h NodeHash.h EdgeHash.h MoviesByYear.h
...
ActorGraph.o: Node.h Edge.h NodeHash.h EdgeHash.h ActorGraph.h

clean:
	rm -rf pathfinder actorconnections extension *.o core*
